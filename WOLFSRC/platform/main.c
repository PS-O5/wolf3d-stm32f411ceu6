    ...
    for (int i = 0; i < NUM_WORLD_SPRITES; i++) {
        ...
        if (sprites[i].type == 1) { 
            ...
            if (dist_x < FLT2FX(0.4f) && dist_y < FLT2FX(0.4f)) {
                ...
                } else if (sprites[i].texture_id == 28) { 
                    player_ammo += 8;
                    sprites[i].active = 0;         
        ...
        // ... (Dog logic abbreviated for brevity, behaves identically scaled to type 3) ...
    }
}
...
int main(void) {
    ...
    while (1) {
        ...
        if (game_state == 3) {
            ...
            draw_mini_string(12, 105, "ALL RIGHTS RESERVED ID SOFTWARE", 7); 
