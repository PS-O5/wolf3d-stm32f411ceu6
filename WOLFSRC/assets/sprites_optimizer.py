...
USED_SPRITES = [27, 28, 50, 58, 66, 74, 90, 91, 92, 93, 95, 97, 98, 99, 107, 115, 123, 131, 132, 133, 134, 135, 136, 137, 421, 422, 423, 424]

def extract_sprites():
    with open('VSWAP.WL1', 'rb') as f:
        ...
        with open('stm32_sprites_8bit.h', 'w') as out:
            ...
            out.write('};\n\n#endif\n')
            print("stm32_sprites_8bit.h generated successfully! The Rainbow Stick is banished.")
